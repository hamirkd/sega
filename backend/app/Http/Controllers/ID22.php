  ...
  <Table ss:ExpandedColumnCount="19" ss:ExpandedRowCount="72" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="15" ss:StyleID="s65">
    ...
    <Cell ss:MergeDown="1" ss:StyleID="m1771927811380"
     ss:Formula="=R[8]C[-4]-R[2]C"><Data ss:Type="Number">0</Data></Cell>
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s255" ss:Formula="=SUM(R[-29]C:R[-2]C)"><Data
      ss:Type="Number">29</Data></Cell>
    <Cell ss:StyleID="s256" ss:Formula="=SUM(R[-29]C:R[-2]C)"><Data
    ...
    <Cell ss:StyleID="s257" ss:Formula="=SUM(R[-29]C:R[-2]C)"><Data
